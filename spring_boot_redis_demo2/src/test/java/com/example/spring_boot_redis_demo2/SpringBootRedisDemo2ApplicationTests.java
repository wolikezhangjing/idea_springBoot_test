package com.example.spring_boot_redis_demo2;

import com.example.spring_boot_redis_demo2.domain.UserVo;
import com.example.spring_boot_redis_demo2.service.RedisService;
import com.example.spring_boot_redis_demo2.util.RedisKeyUtil;
...
public class SpringBootRedisDemo2ApplicationTests {
    ...
    public void testFailure() {
        ...
        userVo.setName("名称");
        userVo.setAge(55);
        redisTemplate.opsForValue().set("failureTimeSetting", userVo, 10, TimeUnit.SECONDS);
    }
